...
# Load the scene with right hand (which includes the robot model)
model = mujoco.MjModel.from_xml_path("assets/scene_right.xml")
...
# Format: (name, [thumb_abd, thumb_flex, thumb_tendon, index, middle, ring, pinky], duration)
